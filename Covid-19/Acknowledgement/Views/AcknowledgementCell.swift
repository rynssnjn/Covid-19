...
public final class AcknowledgementCell: UITableViewCell {

    // MARK: Subviews
    public let libraryTitle: UILabel = {
    ...
    public override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        self.libraryTitle.snp.remakeConstraints { [unowned self] (make: ConstraintMaker) -> Void in
...
extension AcknowledgementCell {
    public static var identifier: String = "AcknowledgementCell"

    public func configure(with country: String) {
        self.libraryTitle.text = country
    }
}
